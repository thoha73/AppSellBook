...
public class Home1 extends BaseActivity {
                    ...
                    if (data != null && data.getData() instanceof Map) {
                        ...
                        if (booksData instanceof List) {
                            ...
                            tv_category.setOnClickListener(view -> {
                                Intent intent = new Intent(Home1.this, AllCategories.class);
    ...
    private void initGridView1(List<com.example.appsellbook.DTOs.Book> list, GridView gridview1, GridView gridview2,GridView gridview3) {
        ...
        BookArrayAdapter adapter1 = new BookArrayAdapter(Home1.this, R.layout.layout_item_book, booksForGridView1,false);
        ...
        BookArrayAdapter adapter2 = new BookArrayAdapter(Home1.this, R.layout.layout_item_book, booksForGridView2,false);
        ...
        BookArrayAdapter adapter3 = new BookArrayAdapter(Home1.this, R.layout.layout_item_book, booksForGridView3,true);
        ...
        gridview1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                if (selectedBook != null) {
                    Intent intent = new Intent(Home1.this, ProductDetail2.class);
