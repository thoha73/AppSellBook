...
public class ProductDetail2  extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        img_cart.setOnClickListener(view -> {
            startActivity(new Intent(ProductDetail2.this, Cart.class));
        });
        ...
        bottom_NavigationView2.setSelectedItemId(R.id.menu_home);
        ...
        if (bookId != 0) {
            ...
            SessionManager sessionManager = new SessionManager(ProductDetail2.this);
        ...
        btn_review.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ProductDetail2.this, Review.class);
...
//                                        user.setLastName((String) userMap.get("lastName"));
                            ...
                            recyclerView.setLayoutManager(new LinearLayoutManager(ProductDetail2.this));
                            CommentArrayAdapter adapter = new CommentArrayAdapter(ProductDetail2.this, new ArrayList<>(commentationList));
            ...
            public void onResponse(Call<GraphQLResponse<Object>> call, Response<GraphQLResponse<Object>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (data.getErrors() != null && !data.getErrors().isEmpty()) {
                        ...
                        new AlertDialog.Builder(ProductDetail2.this)
                                .setTitle("Thông báo")
