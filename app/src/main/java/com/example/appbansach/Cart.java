...
public class Cart {  // Class name should follow Java naming conventions: Capitalized first letter
    int img;
    private String name;
    private String price;

    // Constructor
    public Cart(int img, String name, String price) {  // Corrected "pirce" to "price"
        this.img = img;
        this.name = name;
